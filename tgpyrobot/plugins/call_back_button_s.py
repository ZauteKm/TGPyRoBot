...
from tgpyrobot.tgpyrobot import TGPyRoBot
from tgpyrobot.helper_functions.you_tube_dl_button import youtube_dl_call_back
from tgpyrobot.helper_functions.warn_hlprs.remove_warn import remove_warn
from tgpyrobot.helper_functions.paste_bin_hlpr import del_pasty_ao


@TGPyRoBot.on_callback_query()
async def button(client: TGPyRoBot, callback_query: CallbackQuery):
